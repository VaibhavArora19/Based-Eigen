...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
        <div className="container flex items-center justify-between h-16 px-4 md:px-6">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="#security" className="text-sm font-medium text-white/70 hover:text-white transition-colors">
              Security
            </Link>
            <Link href="#partners" className="text-sm font-medium text-white/70 hover:text-white transition-colors">
              Partners
            </Link>
          </nav>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold leading-tight">
                Your assets, protected by Eigen layer technology
              </h2>
              <p className="text-white/70 text-lg">
                Our protocol leverages Eigen layer's staked assets to create a secure environment for your funds. With
                multiple layers of protection and real-time monitoring, your assets remain safe while still generating
                yield.
              </p>
      ...
      <div className="relative py-24 overflow-hidden bg-gradient-to-b from-transparent to-purple-950/20">
        <div className="container px-4 md:px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to secure your assets?</h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
            Join thousands of users who trust our protocol to protect their funds while earning yield through Eigen
            layer staked assets.
          </p>
