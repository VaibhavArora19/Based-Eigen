    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700">
      <div className="container mx-auto flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <div className="hidden md:flex items-center gap-4">
              ...
              {showWalletMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-md shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden z-50">
                  <div className="p-2">
                    ...
                    <a 
                      href="/app" 
                      className="flex items-center gap-2 w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-md"
                    >
                      Launch App
                    </a>
                    <button 
          ...
          <Button variant="outline" className="hidden md:inline-flex border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200">
            Documentation
          </Button>
        </div>
      </div>
          ...
          <div className="container mx-auto px-4 py-4">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="pt-2 flex flex-col space-y-3">
                ...
                <Button 
                  variant="outline" 
                  className="border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 w-full"
                >
                  Documentation
                </Button>
              </div>
