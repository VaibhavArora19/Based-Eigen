  ...
  const features = [
    {
      ...
      description:
        "Multi-layered protection mechanisms safeguard your assets against potential threats and vulnerabilities.",
    },
    {
      ...
      <div className="container px-4 md:px-6 relative">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/70 text-lg">
            Our protocol combines cutting-edge security features with Eigen layer technology to provide comprehensive
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-4 p-3 rounded-lg bg-black/30 inline-block">{feature.icon}</div>
